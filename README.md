...
ふっかつのじゅもんは強くなる合言葉で、セーブコードの復元機能はありません（しんりょうじょで発行されるじゅもんは記念品）。GM がじゅもんをプレイヤーに尋ねることはありません。

ほかの隠し要素:

- ふっかつのじゅもん「てあらいうがいわくちん」: 石碑のかすれ文字がヒント。レベル 5 + 伝説装備 + 300G（1 回だけ）
- ふっかつのじゅもん「ふるいけや かわずとびこむ みずのおと ばしや」: レベル 10 + 15143G の勇者が復活
...
- 裏ボス「なつかぜだいまおう」: 本編クリア後の隠しルート。クリア後にちょまどひめと話すとヒントが出て、「なつかぜだいまおうに いどむ」で HP200 の裏ボス戦へ。倒すと、実はゲームマスター＝ぬこぬこひめが夏風邪でうなされて暴れていたことが判明し、全員救われる真エンディングになる
